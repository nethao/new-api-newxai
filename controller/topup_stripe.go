...
func (*StripeAdaptor) RequestAmount(c *gin.Context, req *StripePayRequest) {
	...
	if rejectInvalidCreditedQuota(c, id,
		getStripeCreditedQuota(req.Amount, group).Add(getTopUpBonusQuota(req.Amount)),
	) {
		return
	}
...
func (*StripeAdaptor) RequestPay(c *gin.Context, req *StripePayRequest) {
	...
	if rejectInvalidCreditedQuota(c, id,
		decimal.NewFromFloat(chargedMoney).Mul(decimal.NewFromFloat(common.QuotaPerUnit)).Add(getTopUpBonusQuota(req.Amount)),
	) {
		return
	}
