...
func InitEnv() {
	...
	PaymentRateLimitEnable = GetEnvOrDefaultBool("PAYMENT_RATE_LIMIT_ENABLE", true)
	PaymentRateLimitNum = GetEnvOrDefault("PAYMENT_RATE_LIMIT", 20)
	PaymentRateLimitDuration = int64(GetEnvOrDefault("PAYMENT_RATE_LIMIT_DURATION", 20*60))
